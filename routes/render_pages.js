...
//Services 
router.get('/services/:url', function(req,res,next){ 
    let url = req.params.url
    res.render( `services/${url}`,{})
})
//work
router.get('/work/:url', function(req,res,next){ 
    let url = req.params.url
    console.log(url)
    res.render( `work/${url}`,{})
})
...
// work
router.get('/work-details', function(req,res,next){
    res.render('work-details',{})
})

//disclaimer
router.get('/policy-privacy', function(req,res,next){
