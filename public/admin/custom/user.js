var user = {
    ...
    bind_events: function () {
        ...
        $("#create_user_btn").on('click', function (event) {
            ...
            $('form[id="user_form"]').validate({
                ...
                messages: {
                    ...
                    Password:{
                        required: "<span style='font-size:10px; color: red;'>Please create password</span>"
                    }
                },
                errorElement: 'div',
        ...
        obj.user_access = 
            {
              ...
              "feedback_report_access": [
                "edit",
                "view",
                "delete"
              ],
              "email_trigger_access": [
                "edit",
                "view",
                "delete"
              ],
    ...
    edit_user: function (e) {
        ...
        if(obj.password.length > 0){
            $("#Password").attr("Type", "password").val("12341234")
            $("#Password").attr('disabled', true)
            $("#Password").next("label").attr("class", "active");
        }
