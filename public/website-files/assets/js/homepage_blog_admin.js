        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response.status == true) {
                ...
                let blogItem = "";
                console.log(arrOfBlog.length)
                // if (arrOfBlog.length <= 3) {
                    arrOfBlog.slice(0, 3).forEach((obj, i) => {
                        ...
                        `<div class="col-lg-4 col-md-6">
                            <div class="item mb-50">
                                <div class="img">
                                    <a href="${base_url +
                                      "/blog-details/" +
                                      obj.unique_url}"> <img src="${obj
            .thumbnail_image[0].icon_url}" alt=""></a>
                                    <div class="date">
                                        ${formattedDate}
                                    </div>
                                </div>
                                <div class="cont mt-30">
                                    <h6>
                                        <a href="${base_url +
                                          "/blog-details/" +
                                          obj.unique_url}"> ${obj.title}</a>
                                    </h6>
                                    <a href="${base_url +
                                      "/blog-details/" +
                                      obj.unique_url}" class="mt-20 ls1 sub-title">Read More <i
